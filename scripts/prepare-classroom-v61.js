...
const outputHashes = Object.freeze({
  ...
  "main.js": "f2e062d2a6eba5069fa9dc3779c7bf14c7446a844f0951ef421ddf274681c575",
  "preload.js": "8f07b25ce0493bbd973d356085c558feb47a638c9cce895f9e89f43dbaf4cac9"
});
...
main = once(main, 'function legacyV59VaultPath() {', 'function legacyV60VaultPath() {\n  return path.join(app.getPath("userData"), "protected-results-v60", "geometry-tactical-v60.vault.json");\n}\n\nfunction legacyV59VaultPath() {', "V60 legacy path");
